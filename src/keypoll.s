...
# NOT GYM 2
# check if its gym 3:
	call IS_GYM_THREE # a0 == boolean if current maps is GYM 3
	...
	lh t2, 2(t0) # y 
	li t3, 148
	bne t1, t3, NGYM3S # if y not correct, not correct position
	li t3, 96
	bne t2, t3, NGYM3S # if x not correct, not correct position position
	# this means correct position
	# START EVENT BATTLE GYM 1
	call START_GYM_3
	call PRINT_CURRENT_MAP
